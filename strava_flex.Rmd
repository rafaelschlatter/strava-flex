...
df$month <- month.abb[df$calendar_month]
...
monthly_dist_wide$month <- factor(monthly_dist_wide$month, levels = c("Jan", "Feb", "Mar",
  "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"))
monthly_dist_wide$month <-sort(monthly_dist_wide$month)
