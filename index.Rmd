...
# Disabled because on shinyapps.io no packages can be installed by the user.
...
tooltip <- JS("function(){
  return 'Calendar Week ' + this.point.x + ':<br>' +
  'Distance: ' + this.point.y + 'km'
}")

hc <- highchart() %>% 
  hc_chart(type = "areaspline") %>%
  hc_xAxis(
    categories = weekly_dist_wide$month,
